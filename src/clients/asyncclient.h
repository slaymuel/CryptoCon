...
namespace trade_connector{
    ...
    class AsyncClient : public BaseClient<AsyncClient<Config, Extensions...>, Config>, 
        ...
        : BaseClient<AsyncClient<Config, Extensions...>, Config>(rest_host, ws_host, api_key, secret_key, logger) {}
